let RspyList = {
    ...
    SpyList: [
        ...
        {   
            Name: 'lzkj店铺礼包',
            Script: 'shufflewzc_faker3_main/jd_lzkj_wxShopGift.js',
            ListenEnv: ['jd_lzkj_wxShopGift_ids'],
            SetEnv: {
                jd_lzkj_wxShopGift_ids: 'jd_lzkj_wxShopGift_ids',
            },
            TimeOut: 0, 
            Interval: 0,
            RunPanel: [0],
